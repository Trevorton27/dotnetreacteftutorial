...
export default function EditMovie(){
    ...
    [ {id:2, name: 'The Showbox'}]
    const selectedMovieTheaters: movieTheaterDTO[] =  
    [{id:1, name: 'The Old Thee-ay-ter'}]
    ...
    return (
        <>
            <h3>Edit Movie</h3>
            <MovieForm model={{title: 'Return Of The Banana', inTheaters: true, trailer: 'url', releaseDate: new Date('2019-01-01T00:00:00') }}
